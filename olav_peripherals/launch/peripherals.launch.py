...
def generate_launch_description():
    ...
    joy_node = Node(
        ...
        parameters=[
            Path(get_package_share_path("olav_peripherals") / "config/parameters/joy_node_defaults.yaml").as_posix(),
    ...
    gamepad_node = Node(
        ...
        arguments=["--ros-args", "--log-level", LaunchConfiguration("log_level")],
        parameters=[
            Path(get_package_share_path("olav_peripherals") /
                 "config/parameters/gamepad_interface_node_defaults.yaml").as_posix(),
            LaunchConfiguration("parameters_overrides"),
        ],
        remappings=[
            # > Subscriptions
            ...
            ("steering", "commands/input/setpoints/steering"),
            ("heartbeat", "commands/signals/heartbeat"),
            # > Service clients
